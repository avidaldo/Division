...
class DivisionTests {
    ...
    public void testC4() throws Exception {
        ...
        // Deberíamos cuestionarnos los varlores máximos y mínimos de nuestras especificaciones
    }
    ...
    public void testC5() throws Exception {
        ...
        assertEquals(3.33333E-1, resultado, 1E-6);  // Cambiar delta a 1E-6 y ver que falla
