...
class DivisionTests {
    ...
    public void testC1() throws Exception {
        float resultado = UtilidadesMatematicas.calcularDivision(Float.MIN_VALUE, Float.MIN_VALUE);
    ...
    public void testC2() throws Exception {
        float resultado = UtilidadesMatematicas.calcularDivision(Float.MAX_VALUE, Float.MAX_VALUE);
        assertEquals(1F, resultado);
    }
    ...
    public void testC3() throws Exception {
        float resultado = UtilidadesMatematicas.calcularDivision(Float.MIN_VALUE, Float.MAX_VALUE);
    ...
    public void testC4() throws Exception {
        float resultado = UtilidadesMatematicas.calcularDivision(Float.MAX_VALUE, Float.MIN_VALUE);
    ...
    public void testC5() throws Exception {
        float resultado = UtilidadesMatematicas.calcularDivision(1F, 3F);
    ...
    public void testC6() throws Exception {
        float resultado = UtilidadesMatematicas.calcularDivision(0F, Float.MIN_VALUE);
    ...
    public void testException() {
        Exception e = Assertions.assertThrows(Exception.class, () -> {
                    UtilidadesMatematicas.calcularDivision(1, 0);
                });
